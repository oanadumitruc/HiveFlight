...
bool hiveflight_interfaces__msg__drone_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hiveflight_interfaces.msg._drone_message.DroneMessage", full_classname_dest, 53) == 0);
  }
  hiveflight_interfaces__msg__DroneMessage * ros_message = _ros_message;
  {  // sender_id
...
{
  /* NOTE(esteve): Call constructor of DroneMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hiveflight_interfaces.msg._drone_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DroneMessage");
